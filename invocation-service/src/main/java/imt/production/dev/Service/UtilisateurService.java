...
import imt.production.dev.Errors.JoueurApiIndisponibleException;
...
public class UtilisateurService {
    ...
    public Map<String, String> createUtilisateur(UtilisateurDTO dto) {
        ...
        try {
            ...
            utilisateurRepository.deleteByUsername(dto.getUsername());
            throw new JoueurApiIndisponibleException();
        }
