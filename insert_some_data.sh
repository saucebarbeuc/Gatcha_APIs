...
declare -a produits=(
  '{"id": 1, "nom": "Produit Test", "description": "Description du produit de test pour vérifier les contraintes.", "prix": 100}'
  ...
  '{"id": 7, "nom": "Produit de Luxe", "description": "Produit de luxe pour les occasions spéciales et les cadeaux.", "prix": 500}'
...
for produit in "${produits[@]}"; do
  curl -X POST -H "Content-Type: application/json" -d "$produit" "$URL"
  echo
done
